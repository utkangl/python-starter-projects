...
class Hand:
        ...
        def add_card_to_hand(self,card):
            ...
            if card.rank == "ace": # as varsa as sayısına 1 ekliyoruz
                self.aces += 1
        # ilk başta asın değerini 11 olarak tanımladığımız için eğer elimizdeki kartların toplam değeri 21den fazlaysa ası 1 olarak kullanmak için değerini 10 eksiltiyoruz                        
